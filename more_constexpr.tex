...
Since such consistency is not a requirement, some compilers already 
make assumptions about how the C library behaves generating code which is
independent of the runtime C library.
...
be consistent across library implementations.  On clang (targeting
...
_Z1fv:
	...
	retq
\end{Verbatim}
and on GCC, equivalent code is generated.
