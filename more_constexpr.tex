...
Since such consistency is not a requirement, some compilers already assume knowledge of
the C standard library.  {\bf ]I don't understand this! For what purpose is this knowledge being assumed and how does it relate to the conclusion below that the result is independent of the C library?]}
...
be consistent across library implementations.  However {\bf [This 'however' sort of implies that we're about to reveal that it is consistent across library implementations; probably needs slight rewording]}, on clang (targeting
...
_Z1fv:
	...
	retq
\end{Verbatim}
and on GCC, similar code is generated. {\bf [But presumably giving a different value?]}
