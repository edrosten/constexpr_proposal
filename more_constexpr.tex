...
The following proposed changes refer to the Working Paper~\cite{WorkingPaper}. Highlighting in \highlight{red} indicates changes proposed in this paper, whilst \oldhighlight{green} indicates changes proposed in the companion paper, \cite{Rosten-constexpr}.
