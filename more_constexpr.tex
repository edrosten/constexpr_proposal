...
{\bf Nothing that springs to mind!}
...
// [sf.cmath.assoc\_\_legendre], {\em associated Laguerre polynomials}
...
\subsection{Modifications to  ``Associated Laguerre polynomials''  [sf.cmath.assoc\_\_legendre]}
