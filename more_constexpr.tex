...
// [sf.cmath.assoc\bigund laguerre], {\em associated Laguerre polynomials}
...
// [sf.cmath.assoc{\bigund}legendre], {\em associated Legendre polynomials}
...
\vspace{2ex}
// [sf.cmath.comp{\bigund}ellint{\bigund}1], {\em complete elliptic integral of the first kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.comp{\bigund}ellint{\bigund}2], {\em complete elliptic integral of the second kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.comp{\bigund}ellint{\bigund}3], {\em complete elliptic integral of the third kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.cyl{\bigund}bessel{\bigund}i, {\em regular modified cylindrical Bessel functions}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.cyl{\bigund}bessel{\bigund}j], {\em cylindrical Bessel functions of the first kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.cyl{\bigund}bessel{\bigund}k], {\em irregular modified cylindrical Bessel functions}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.cyl{\bigund}neumann], {\em Cylindrical Neumann functions}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.ellint{\bigund}1], {\em incomplete elliptic integral of the first kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.ellint{\bigund}2], {\em incomplete elliptic integral of the second kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.ellint{\bigund}3], {\em incomplete elliptic integral of the third kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.reimann{\bigund}zeta], {\em Reimann zeta function}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.sph{\bigund}bessel], {\em Spherical Bessel functions of the first kind}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.sph{\bigund}legendre], {\em spherical associated Legendre functions}
\vspace{2ex}
...
\vspace{2ex}
// [sf.cmath.sph{\bigund}neumann], {\em spherical Neumann functions}
\vspace{2ex}
...
\subsection{Modifications to  ``Associated Legendre polynomials''  [sf.cmath.assoc{\bigund}legendre]}
