...
\begin{enumerate}
	...
	\item [R7] Rebase to N4878 and add a note that \code{lerp}, which is declared \constexpr, has been added to \cmath.
\end{enumerate}
...
\highlight{
	\code{\#define \_\_cpp\_lib\_constexpr\_math} \qquad \qquad 201902L
