...
{\small (4.21)} --- a \emph{throw-expression} [expr.throw] or a dynamic cast [expr.dynamic.cast] or \code{typeid} [expr.typeid] expression that would throw an exception; \remove{\st{or}}

{\small (4.22)} --- an invocation of the \code{va\_arg} macro [cstdarg.syn]\remove{\st{.}}\highlight{;or}
