...
As for~\eq{10/3}, what result should we expect? According to [cfenv.syn] footnote 1, the result is implementation defined. However, this issue is currently under active discussion. The key point for this paper is that, whatever decision is made, can be consistently applied to those functions in \cmath\ which we propose should be declared \constexpr.
