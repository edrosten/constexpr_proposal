...
simple. Bearing in mind that gcc already declares the more complicated
functions \code{std::exp} and \code{std::sqrt} to be \constexpr, it is hoped
that any burden implicit in this proposal is minimal.
