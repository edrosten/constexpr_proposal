...
quantifiable and can be used to compute a number representing the QoI.
...
\begin{enumerate}
	...
	\item The framework allows for QoI to be quantified in a way which doesn't simply label all
