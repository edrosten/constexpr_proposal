...
Nevertheless, it seems reasonable in our opinion that both clang and GCC tacitly allow this, as discussed in detail in \sect{Motivation}.
...
\begin{enumerate}
	...
	\item Even without \constexpr, current practice has long allowed for differences between translation time and runtime. For example, optimization may emit code which entirely bypasses calls to the C library, instead generating results at translation time.
